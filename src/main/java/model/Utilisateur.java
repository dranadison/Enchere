...
public class Utilisateur extends DBTable{
    ...
    public Data login() throws Exception{
        ...
        String t=Token.getToken(u, "2:0:0");
    ...
    public void logout(String valToken) throws Exception{
        Connection c=(new Connexion()).getConnection();
        Token token=(Token)(this.find("select * from Token where valeur='"+valToken+"'", c)[0]);
