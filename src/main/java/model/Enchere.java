...
public class Enchere extends DBTable{
    ...
    public static Enchere[] search(String desc,int categorieid,String date,double prix,int status) throws  Exception {
      
        String sql = "select * from enchere where ";
        if(desc != null || date != null || prix != 0 || categorieid != 0 || status != 0) {
