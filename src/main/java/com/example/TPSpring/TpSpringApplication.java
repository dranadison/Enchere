...
//Utilisateur
    ...
    public Object infoUtilisateur(@RequestParam(value = "idUtilisatuer") int id) throws Exception {
        try{
            Utilisateur u=new Utilisateur();
            u.setId(id);
            return u.recherche();
...
//Rechage Compte 
    ...
    public Object demandeRecharge(@RequestParam(value = "id") int id,@RequestParam(value = "montant") double montant) throws Exception {
        try{
            Recharge.demandeRecharge(id, montant);
            return new Data("OK");
        }
        catch(Exception e)
        {
...
//Enchere
    ...
    public Object nouveauenchere(@RequestParam(value = "idUtilisateur") int idUtilisateur,@RequestParam(value = "idCategorie") int idCategorie,@RequestParam(value = "descri") String descri,@RequestParam(value = "durre") double durre,@RequestParam(value = "prixminimal") double prixminimal) throws Exception {
    ...
    public Object getListEnchereAnah(@RequestParam(value = "id") int id) throws Exception {
        try{
              Enchere tab=new Enchere().getListEnchereAnah(id);
            return new Data(tab);
        }
        catch(Exception e)
        {
    ...
    public Object recherche(@RequestParam(value = "idCategorie") int idCategorie,@RequestParam(value = "descri") String descri,@RequestParam(value = "date") String date,@RequestParam(value = "prixminimal") double prixminimal,@RequestParam(value = "status") int status)throws Exception {
...
//offre
    ...
    public Object nouvelleoffre(@RequestParam(value = "idenchere") int idenchere,@RequestParam(value = "idutilisateur") int idutilisateur,@RequestParam(value = "montant") double montant) throws Exception {
        Enchere[] tab=(Enchere[])getListEncheres();
        Utilisateur u=(Utilisateur)infoUtilisateur(idutilisateur);
        Offre o=new Offre();
